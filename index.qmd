...
## <span class="orange-text">Une correction partielle de la dépendance automobile</span> : Comment la réallocation de l’espace de la voirie et le transport collectif façonnent l’intensification des activités à Montréal

::: full-width
![](images/Presentation_Examen_Blanc_JiaYiYu.jpg){width="100%"}
:::

### Intro/Problématique

::: {.callout-note .justify collapse="true" title="Voir détails"}
